...
int main() {
    const char *students_filename = "./ExampleTest/students.txt";
    const char *courses_filename = "./ExampleTest/courses.txt";
    const char *hackers_filename = "./ExampleTest/hackers.txt";
