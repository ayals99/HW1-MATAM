CC := gcc
CFLAGS := -std=c99 -o HackEnrollment -I/home/mtm/public/2223b/ex1 -I/home/mtm/public/2223b/ex1/tool -Wall -pedantic-errors -Werror -DNDEBUG
...
tool/Person.o: tool/Person.c tool/Person.h tool/Hacker.h Node.h
	$(CC) $(CFLAGS) -c $< -o $@
